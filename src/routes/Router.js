...
const  DispatchTest= Loadable(lazy(() => import('../views/operations/Dispatchh/test')));

const  FindaRoll= Loadable(lazy(() => import('../views/operations/FindR/FindaRoll')));
const  FindSmallRollView= Loadable(lazy(() => import('../views/operations/FindR/SmallRollViewS')));
...
const  InvoicesPrint= Loadable(lazy(() => import('../views/InvoicePrint/invoice')));
const  SmallPrint= Loadable(lazy(() => import('../views/InvoicePrint/smallRoll')));
const  JumboPrint= Loadable(lazy(() => import('../views/InvoicePrint/jumboRoll')));
...
const  StockManagementBomReportOnlyView= Loadable(lazy(() => import('../views/operations/StockM/BomReportOnlyView')));
...
const  StockManagementProductionReportOnlyView= Loadable(lazy(() => import('../views/operations/StockM/ProductionReportOnlyView')));
const  Stock3View = Loadable(lazy(() => import('../views/operations/StockM/Three')));
...
const  CategoriesView = Loadable(lazy(() => import('../views/inventory/Category/View')));
...
const  VendorsView= Loadable(lazy(() => import('../views/inventory/Vendor/View')));
...
const ThemeRoutes = [
  {
    ...
    element: <FullLayout />,
    children: [
      { path: '/', name: 'Home', element: <ProtectedRoute> <Navigate to="/dashboards/team" />  </ProtectedRoute> },
      ...
      { path: '/operations/dispatch/test', name: 'Modern', exact: true, element: <ProtectedRoute> <DispatchTest /> </ProtectedRoute> },
     
      { path: '/operations/find-a-roll', name: 'Modern', exact: true, element:  <ProtectedRoute><FindaRoll /> </ProtectedRoute> },
      { path: '/operations/find-a-roll/small-roll', name: 'Modern', exact: true, element:  <ProtectedRoute><FindSmallRollView /> </ProtectedRoute> },
      ...
      { path: '/operations/Bom-Report/view', name: 'Modern', exact: true, element: <ProtectedRoute> <StockManagementBomReportOnlyView /></ProtectedRoute> },
      ...
      { path: '/operations/Production-Report/view', name: 'Modern', exact: true, element: <ProtectedRoute> <StockManagementProductionReportOnlyView /></ProtectedRoute> },
      { path: '/operations/Production-Report/3d', name: 'Modern', exact: true, element: <ProtectedRoute> <Stock3View /></ProtectedRoute> },
      ...
      { path: '/inventory/vendors/view', name: 'Modern', exact: true, element: <ProtectedRoute> <VendorsView />  </ProtectedRoute>},
      ...
      { path: '/inventory/categories/view', name: 'Modern', exact: true, element:  <ProtectedRoute><CategoriesView />  </ProtectedRoute>},
