...
const Categories = () => {
  ...
  const handleViewClick = (categoryId) => {
    // Navigate to the edit page with the item's id
    // Navigate(`/resources/address-types/edit/${itemId}`);
    navigate(`/inventory/categories/view/?id=${categoryId}`);
  };
              ...
              {data.map((category) => (
                <tr key={category.name}>
                  ...
                  <td>
                      ...
                      <button type="button" className="btn mybtncustomer btn-secondary btn-sm mr-2" onClick={() => handleViewClick(category.id)}><i className="bi bi-eye-fill my-eye-color" /></button>
