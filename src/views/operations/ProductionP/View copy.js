...
const BomReportFunction = (product)=>{
  navigate('/operations/Bom-Report',{state:{product}});
}
const ParametersReportFunction = (product)=>{
  navigate('/operations/Production-Report',{state:{product}});
}
...
useEffect(()=>{
  ...
  const fetchDataPlan = async () => {
    ...
    console.log('line3Data',line3Data);
    console.log('line4Data',line4Data);
    // Set state
    setLine1(line1Data);
    setLine2(line2Data);
    setLine3(line3Data);
