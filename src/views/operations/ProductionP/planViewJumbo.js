...
const JumbotronComponent = (props) => {
  ...
  {
    data.length !== 0 ? <>
    {`Jumbo Rolls (Total : ${product.total_jumbo_roll_count}, Qty : ${product.total_jumbo_roll_quantity} m, Small Rolls => Count : ${product.total_small_roll_count} , Qty : ${product.total_small_roll_quantity} m)`}
    {/* {`Jumbo Rolls (Total : ${product.total_jumbo_roll_count}, Qty : ${product.total_jumbo_roll_quantity} m, Small Rolls => Count : ${product.total_small_roll_count} , Qty : ${product.total_small_roll_quantity} m, Avg GSM : 1334.69 g/m2`} */}
          ...
          {data.map((pro,index) => {
            return<React.Fragment key={pro.id}>
              ...
              <tbody>
                ...
                <tr>
                  <td style={{paddingTop: "20px",textAlign:'center'}}>{index+1}</td>
                  <td style={{paddingTop: "20px",textAlign:'center'}}>{pro.quantity}</td>
                  ...
                  <td>       
                    <div style={{paddingTop: "20px",textAlign:'center',width: "400px" }}>
                  ...
                  <td>
                    <td style={{paddingTop: "20px",textAlign:'center'}}><Button ><i className="bi bi-printer-fill my-bell-color" onClick={()=>JumboPrint(pro.id)} /></Button></td>
                    <td style={{paddingTop: "20px",textAlign:'center'}}><Button onClick={()=>updateRollTogglefunction(pro)}><i className="bi bi-pencil-fill my-pen-color" /></Button></td>
                    <td style={{paddingTop: "20px",textAlign:'center'}}><Button  onClick={()=>handleDeleteClick(pro,index)}><i className="bi bi-trash-fill my-trash-color" /></Button></td>
                  </td>
                </tr>
              </tbody>
              </React.Fragment>
