...
const JumbotronComponent = ({JumboDataFromPlan,modal,toggle,data2,data6}) => {
...
console.log('JumboDataFromPlan in product',JumboDataFromPlan);
 ...
 const CancelPaste = ()=>{
  ...
  const addItem1 = () => {
    ...
    newItems.push({ 
      ...
      jumbo_roll_id:'1',
      consumption_date:'',
      quality_id:JumboDataFromPlan.product_details.quality_id,
      quality_name:JumboDataFromPlan.product_details.quality_name,
      color_id	:JumboDataFromPlan.product_details.color_id,
      color_name	:JumboDataFromPlan.product_details.color_name,
      vessel_no:'',
      shift:'',
      paste_type_id:'x',
      empty_vessel_weight:'',
                 ...
                 <Form onSubmit={handleSubmit}>
                   <Row>
                      ...
                      <div style={{ background:'#ff9c7a',color: 'black', marginBottom: '10px', padding:"5px 10px"}}>
                        ...
                        <Col>
                          <FormGroup>
                            <Table className="qa-packaging-roll-modal-items-padding onelinethtdPaste" responsive>
                              <thead>
                                <tr>
                                <th><div> #	</div></th>
                                    ...
                                    <tr key={item}>
                                      ...
                                      <td>
                                        ...
                                        <Input type="text" 
                                              name="quality_name" 
                                              id="name"
                                              value={JumboDataFromPlan.product_details.quality_name}
                                              onChange={e => handleInputChange1(index, e)} 
                                        ...
                                        <td>
                                          <Input name="color_id"
                                                value={JumboDataFromPlan.product_details.color_name} 
                                                type="text" 
                                                onChange={e => handleInputChange1(index, e)}  
