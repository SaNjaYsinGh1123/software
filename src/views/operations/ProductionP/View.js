...
useEffect(()=>{
  ...
  const fetchDataPlan = async () => {
    ...
    console.log('line5Data',handleSortAndGroup(line5Data));
    console.log('line6Data',handleSortAndGroup(line6Data));
    // Set state
      ...
      <ComponentCard title="">
        ...
        <TabContent className="p-4" activeTab={activeTab}>
          ...
          <TabPane tabId="5">
                <Table responsive size="sm">
                   <thead>
                      {activeTab === '5' &&  <PlanLineDetailsView Refreshkey={refreshKey} line={5} planDate={planDate}/>}  
                  </thead>
                  
                </Table>
                {line5?.length <1 ? <div className="my-btn-color-temp"  style={{background: 'aliceblue',textAlign:'center',border: '2px solid black',color:'black',marginBottom:'2px',padding:'40px'}}>
                    <div>
                      <i className="bi bi-emoji-frown" style={{fontSize:'25px',color:'black'}}/>
                    </div>
                    No item on this production line.
               </div>:line5.map((product)=>{
                return <React.Fragment key={product.id}>
                        <ComponentCard4>
                          <div className='table-margin'>
                          <Table className='table-margin-zero' responsive size="sm">
                            ...
                            <Table responsive size="sm">
                              ...
                              {activeTab === '5' &&  <PlanViewJumbo Refreshkey={refreshKey} product={product} updateRollTogglefunction={setterJumboUpdateDataFromPlan}/>}
                              {product.isLastInPass ? <div style={{display:'flex',justifyContent:'space-between',background:'#f1c76f',alignItems:'center',margin:"10px 0px",padding:"5px"}}>
                                                                                <span className='production-plan-page-collape-heading' style={{width:'100%',textAlign:'center'}}>Pass {product.is_passed} Completed</span>
                                                                            </div>:''}
                          </div>
          ...
          <TabPane tabId="6">
                <Table responsive size="sm">
                   <thead>
                      {activeTab === '6' &&  <PlanLineDetailsView Refreshkey={refreshKey} line={6} planDate={planDate}/>}  
                  </thead>
                  
                </Table>
                {line6?.length <1 ? <div className="my-btn-color-temp"  style={{background: 'aliceblue',textAlign:'center',border: '2px solid black',color:'black',marginBottom:'2px',padding:'40px'}}>
                    <div>
                      <i className="bi bi-emoji-frown" style={{fontSize:'25px',color:'black'}}/>
                    </div>
                    No item on this production line.
               </div>:line6.map((product)=>{
                return <React.Fragment key={product.id}>
                        <ComponentCard4>
                          <div className='table-margin'>
                          <Table className='table-margin-zero' responsive size="sm">
                            ...
                            <Table responsive size="sm">
                              ...
                              {activeTab === '6' &&  <PlanViewJumbo Refreshkey={refreshKey} product={product} updateRollTogglefunction={setterJumboUpdateDataFromPlan}/>}
                              {product.isLastInPass ? <div style={{display:'flex',justifyContent:'space-between',background:'#f1c76f',alignItems:'center',margin:"10px 0px",padding:"5px"}}>
                                                                                <span className='production-plan-page-collape-heading' style={{width:'100%',textAlign:'center'}}>Pass {product.is_passed} Completed</span>
                                                                            </div>:''}
                          </div>
