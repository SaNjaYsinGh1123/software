...
const Qualities = () => {
  ...
  const handleEditClick = (item) => {
    ...
    navigate('/resources/qualities/edit', { state: item });
  };
  const handleEditAdd = () => {
  ...
  useEffect(() => {
    ...
    const fetchData = async () => {
      ...
      const response = await fetch(`https://factory.teamasia.in/api/public/qualities/?page=${currentPage}&limit=10&title=name&order=asc`, {
        method: 'GET', 
        headers: {
          'Authorization': `Bearer ${token}`
        }
