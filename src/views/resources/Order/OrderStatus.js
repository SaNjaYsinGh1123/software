...
const OrderStatus = () => {
  ...
  const handleDeleteClick = async (itemId) => {
    try {
      ...
      const response = await fetch(`https://factory.teamasia.in/api/public/orderstatuses/${itemId}`, {
        method: 'DELETE',
        headers: {
  ...
  useEffect(() => {
    ...
    const fetchData = async () => {
      ...
      const response = await fetch(`https://factory.teamasia.in/api/public/orderstatuses/?is_trashed=${istrashed}`, {
        method: 'GET', 
        headers: {
          'Authorization': `Bearer ${token}`
        }
