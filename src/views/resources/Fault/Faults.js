...
// import ComponentCard2 from '../../../assets/images/logos/logo-text.png';
      ...
      <table className="table" style={tableStyle}>
              ...
              <tbody>
                {data.map((product) => (
                  <tr key={product.id}>
                  <td>{product.code}</td>
                  <td><img src={`https://factory.teamasia.in/api/public/uploads/${product.image_path}`} alt={product.image_path} style={{width:"40px",maxHeight:"50px"}}/></td>
                  <td>{product.name}</td>
