...
const InventoryTypes = () => {
  ...
  const handleDeleteClick = async (itemId) => {
    try {
      ...
      const response = await fetch(`https://factory.teamasia.in/api/public/inventorytypes/${itemId}`, {
        method: 'DELETE',
        headers: {
  ...
  useEffect(() => {
    ...
    const fetchData = async () => {
      ...
      const response = await fetch(`https://factory.teamasia.in/api/public/inventorytypes/?is_trashed=${istrashed}`, {
        method: 'GET', 
        headers: {
          'Authorization': `Bearer ${token}`
        }
