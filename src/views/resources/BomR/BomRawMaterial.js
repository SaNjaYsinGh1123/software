...
const BomRawMaterial = () => {
  ...
  const handleDeleteClick = async (itemId) => {
    try {
      ...
      const response = await fetch(`https://factory.teamasia.in/api/public/bomrawmaterialcategories/${itemId}`, {
        method: 'DELETE',
        headers: {
  ...
  >
    ...
    <div style={{ display: 'flex', justifyContent: 'center', alignItems: 'center', height: '100%' }}>
      <table className="table" style={tableStyle}>
              <thead>
              <tr>
            <th>Bom Raw Material Category Name</th>
            <th>Sort Order</th>
            <th>Actions</th>
          </tr>
              </thead>
