...
const Sidebar = () => {
  ...
  return (
    <div className={`sidebarBox shadow bg-${activeBg} ${isFixed ? 'fixedSidebar' : ''}`} style={{paddingLeft: "0px",marginRight:"5px",border: '1px solid #d9d9d9'}}>
        ...
        <div style={{marginBottom:"20px"}}>
          ...
          <Nav vertical className={activeBg === 'white' ? '' : 'lightText'}>
            {SidebarData.map((navi) => {
              ...
              if (navi.caption) {
                return (
                  <div className="navCaption fw-bold text-uppercase" key={navi.caption}>
                    {/* {navi.caption} */}
                     <hr/>
                  </div>
                );
